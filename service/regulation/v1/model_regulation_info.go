...
type RegulationInfo struct {
	...
	SceneType        *json.Number `json:"scene_type,omitempty"`        // 因公出行场景，（0-个人用车、1-商务出行、2-需审批差旅制度、3-加班、4-办公地点通勤、5-疫期通勤、11-会议用车、91-代叫车、92-接送机、93-包车、94-代驾、95-私车同行、96-行前审批、104-无需审批差旅制度）
...
type RegulationInfoBuilder struct {
	...
	sourceSet           bool
	sceneType           json.Number // 因公出行场景，（0-个人用车、1-商务出行、2-需审批差旅制度、3-加班、4-办公地点通勤、5-疫期通勤、11-会议用车、91-代叫车、92-接送机、93-包车、94-代驾、95-私车同行、96-行前审批、104-无需审批差旅制度）
	sceneTypeSet        bool
...
func (builder *RegulationInfoBuilder) SceneType(sceneType json.Number) *RegulationInfoBuilder {
