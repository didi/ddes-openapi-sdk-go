...
type GetCarOrderDetailReply struct {
	...
	CallEmployeeName        *string                `json:"call_employee_name,omitempty"`        // 叫车人姓名，叫车人id所对应的员工姓名
	PassengerEmployeeNumber *string                `json:"passenger_employee_number,omitempty"` // 乘车人工号，注：若人员离职或删除，该字段不会返回
	DepartmentCode          *string                `json:"department_code,omitempty"`           // 部门编码，部门id对应的部门编码
	CarPrice                *string                `json:"car_price,omitempty"`                 // 车费金额，单位：元
	DriverCard              *string                `json:"driver_card,omitempty"`               // 车牌号，脱敏车牌号（需白名单开启）
	ProductCategory         *int32                 `json:"product_category,omitempty"`          // 品类/3.0车型列表，如5000快车、5001特快、5002优享等
	ActualStartScene        *string                `json:"actual_start_scene,omitempty"`        // 实际出发地场景，1机场，2火车站，3其他
	ActualEndScene          *string                `json:"actual_end_scene,omitempty"`          // 实际目的地场景，1机场，2火车站，3其他
	CrossFlag               *int32                 `json:"cross_flag,omitempty"`                // 企业级跨城单标记，0否，1是
	LegalEntityInfo         *LegalEntityInfo       `json:"legal_entity_info,omitempty"`
	HistoryDestinations     []HistoryDestination   `json:"history_destinations,omitempty"` // 修改过的历史目的地信息，参考HistoryDestination对象
	PassengerList           []OrderPassengerInfo   `json:"passenger_list,omitempty"`       // 出行人对象，参考PassengerInfo对象
	RcList                  []RcListItem           `json:"rc_list,omitempty"`              // 管控信息，参考RcListItem对象
}
