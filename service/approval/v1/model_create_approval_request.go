...
// CreateApprovalRequest 创建差旅审批单入参
...
type CreateApprovalRequestBuilder struct {
...
func NewCreateApprovalRequestBuilder() *CreateApprovalRequestBuilder {
	return &CreateApprovalRequestBuilder{}
}
func (builder *CreateApprovalRequestBuilder) ClientId(clientId string) *CreateApprovalRequestBuilder {
	builder.clientId = clientId
	builder.clientIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) AccessToken(accessToken string) *CreateApprovalRequestBuilder {
	builder.accessToken = accessToken
	builder.accessTokenSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) Timestamp(timestamp int64) *CreateApprovalRequestBuilder {
	builder.timestamp = timestamp
	builder.timestampSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) CompanyId(companyId string) *CreateApprovalRequestBuilder {
	builder.companyId = companyId
	builder.companyIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) Sign(sign string) *CreateApprovalRequestBuilder {
	builder.sign = sign
	builder.signSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) OutTripId(outTripId string) *CreateApprovalRequestBuilder {
	builder.outTripId = outTripId
	builder.outTripIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ApprovalType(approvalType int32) *CreateApprovalRequestBuilder {
	builder.approvalType = approvalType
	builder.approvalTypeSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) RegulationId(regulationId string) *CreateApprovalRequestBuilder {
	builder.regulationId = regulationId
	builder.regulationIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) PolicyType(policyType int32) *CreateApprovalRequestBuilder {
	builder.policyType = policyType
	builder.policyTypeSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) PolicyTypeValue(policyTypeValue string) *CreateApprovalRequestBuilder {
	builder.policyTypeValue = policyTypeValue
	builder.policyTypeValueSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) OutApprovalId(outApprovalId string) *CreateApprovalRequestBuilder {
	builder.outApprovalId = outApprovalId
	builder.outApprovalIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) BudgetCenterId(budgetCenterId string) *CreateApprovalRequestBuilder {
	builder.budgetCenterId = budgetCenterId
	builder.budgetCenterIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) Name(name string) *CreateApprovalRequestBuilder {
	builder.name = name
	builder.nameSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) OutBudgetId(outBudgetId string) *CreateApprovalRequestBuilder {
	builder.outBudgetId = outBudgetId
	builder.outBudgetIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) Reason(reason string) *CreateApprovalRequestBuilder {
	builder.reason = reason
	builder.reasonSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) MemberType(memberType int32) *CreateApprovalRequestBuilder {
	builder.memberType = memberType
	builder.memberTypeSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) Phone(phone string) *CreateApprovalRequestBuilder {
	builder.phone = phone
	builder.phoneSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) EmployeeNumber(employeeNumber string) *CreateApprovalRequestBuilder {
	builder.employeeNumber = employeeNumber
	builder.employeeNumberSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) Email(email string) *CreateApprovalRequestBuilder {
	builder.email = email
	builder.emailSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExecutiveRegulationType(executiveRegulationType int32) *CreateApprovalRequestBuilder {
	builder.executiveRegulationType = executiveRegulationType
	builder.executiveRegulationTypeSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExecutiveRegulationId(executiveRegulationId string) *CreateApprovalRequestBuilder {
	builder.executiveRegulationId = executiveRegulationId
	builder.executiveRegulationIdSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExecutiveRegulationMemberType(executiveRegulationMemberType int32) *CreateApprovalRequestBuilder {
	builder.executiveRegulationMemberType = executiveRegulationMemberType
	builder.executiveRegulationMemberTypeSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExecutiveRegulationMember(executiveRegulationMember string) *CreateApprovalRequestBuilder {
	builder.executiveRegulationMember = executiveRegulationMember
	builder.executiveRegulationMemberSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) OutTripInfo(outTripInfo string) *CreateApprovalRequestBuilder {
	builder.outTripInfo = outTripInfo
	builder.outTripInfoSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExtraInfo(extraInfo string) *CreateApprovalRequestBuilder {
	builder.extraInfo = extraInfo
	builder.extraInfoSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExtendFieldList(extendFieldList string) *CreateApprovalRequestBuilder {
	builder.extendFieldList = extendFieldList
	builder.extendFieldListSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) TravelDetail(travelDetail string) *CreateApprovalRequestBuilder {
	builder.travelDetail = travelDetail
	builder.travelDetailSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) TravelBudget(travelBudget string) *CreateApprovalRequestBuilder {
	builder.travelBudget = travelBudget
	builder.travelBudgetSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) TravelManagement(travelManagement string) *CreateApprovalRequestBuilder {
	builder.travelManagement = travelManagement
	builder.travelManagementSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) PassengerList(passengerList string) *CreateApprovalRequestBuilder {
	builder.passengerList = passengerList
	builder.passengerListSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) BudgetCenterList(budgetCenterList string) *CreateApprovalRequestBuilder {
	builder.budgetCenterList = budgetCenterList
	builder.budgetCenterListSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) OutTripInfoObj(outTripInfoObj OutTripInfo) *CreateApprovalRequestBuilder {
	builder.outTripInfoObj = outTripInfoObj
	builder.outTripInfoObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExtraInfoObj(extraInfoObj map[string]string) *CreateApprovalRequestBuilder {
	builder.extraInfoObj = extraInfoObj
	builder.extraInfoObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) ExtendFieldListObj(extendFieldListObj ExtendFieldList) *CreateApprovalRequestBuilder {
	builder.extendFieldListObj = extendFieldListObj
	builder.extendFieldListObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) TravelDetailObj(travelDetailObj TravelDetail) *CreateApprovalRequestBuilder {
	builder.travelDetailObj = travelDetailObj
	builder.travelDetailObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) TravelBudgetObj(travelBudgetObj TravelBudget) *CreateApprovalRequestBuilder {
	builder.travelBudgetObj = travelBudgetObj
	builder.travelBudgetObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) TravelManagementObj(travelManagementObj TravelManagement) *CreateApprovalRequestBuilder {
	builder.travelManagementObj = travelManagementObj
	builder.travelManagementObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) PassengerListObj(passengerListObj []TripPassenger) *CreateApprovalRequestBuilder {
	builder.passengerListObj = passengerListObj
	builder.passengerListObjSet = true
	return builder
}
func (builder *CreateApprovalRequestBuilder) BudgetCenterListObj(budgetCenterListObj []BudgetCenterListItem) *CreateApprovalRequestBuilder {
	builder.budgetCenterListObj = budgetCenterListObj
	builder.budgetCenterListObjSet = true
	return builder
}

func (builder *CreateApprovalRequestBuilder) Build() *CreateApprovalRequest {
