...
// NotGenBDOfDaiJiaItem 未出账单 - 代驾,参考内部文档进行定义；
type NotGenBDOfDaiJiaItem struct {
...
type NotGenBDOfDaiJiaItemBuilder struct {
...
func NewNotGenBDOfDaiJiaItemBuilder() *NotGenBDOfDaiJiaItemBuilder {
	return &NotGenBDOfDaiJiaItemBuilder{}
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsCurrentTerm(isCurrentTerm string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isCurrentTerm = isCurrentTerm
	builder.isCurrentTermSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OrderId(orderId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.orderId = orderId
	builder.orderIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OutOrderId(outOrderId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.outOrderId = outOrderId
	builder.outOrderIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OrderSource(orderSource string) *NotGenBDOfDaiJiaItemBuilder {
	builder.orderSource = orderSource
	builder.orderSourceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Status(status string) *NotGenBDOfDaiJiaItemBuilder {
	builder.status = status
	builder.statusSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Rule(rule string) *NotGenBDOfDaiJiaItemBuilder {
	builder.rule = rule
	builder.ruleSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RequireLevel(requireLevel string) *NotGenBDOfDaiJiaItemBuilder {
	builder.requireLevel = requireLevel
	builder.requireLevelSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) MemberName(memberName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.memberName = memberName
	builder.memberNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) EmployeeNumber(employeeNumber string) *NotGenBDOfDaiJiaItemBuilder {
	builder.employeeNumber = employeeNumber
	builder.employeeNumberSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) MemberMail(memberMail string) *NotGenBDOfDaiJiaItemBuilder {
	builder.memberMail = memberMail
	builder.memberMailSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CallPhone(callPhone string) *NotGenBDOfDaiJiaItemBuilder {
	builder.callPhone = callPhone
	builder.callPhoneSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) DepartmentName(departmentName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.departmentName = departmentName
	builder.departmentNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OutBudgetId(outBudgetId string) *NotGenBDOfDaiJiaItemBuilder {
	builder.outBudgetId = outBudgetId
	builder.outBudgetIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Department(department string) *NotGenBDOfDaiJiaItemBuilder {
	builder.department = department
	builder.departmentSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BranchName(branchName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.branchName = branchName
	builder.branchNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PassengerMemberNumber(passengerMemberNumber string) *NotGenBDOfDaiJiaItemBuilder {
	builder.passengerMemberNumber = passengerMemberNumber
	builder.passengerMemberNumberSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PassengerName(passengerName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.passengerName = passengerName
	builder.passengerNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PassengerPhone(passengerPhone string) *NotGenBDOfDaiJiaItemBuilder {
	builder.passengerPhone = passengerPhone
	builder.passengerPhoneSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PayType(payType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.payType = payType
	builder.payTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) TotalPrice(totalPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.totalPrice = totalPrice
	builder.totalPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyRealPay(companyRealPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyRealPay = companyRealPay
	builder.companyRealPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PersonalRealPay(personalRealPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.personalRealPay = personalRealPay
	builder.personalRealPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RealVoucherPay(realVoucherPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.realVoucherPay = realVoucherPay
	builder.realVoucherPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Cost(cost float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.cost = cost
	builder.costSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) DiscountAfterPrice(discountAfterPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.discountAfterPrice = discountAfterPrice
	builder.discountAfterPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyRealRefund(companyRealRefund float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyRealRefund = companyRealRefund
	builder.companyRealRefundSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Type(type_ string) *NotGenBDOfDaiJiaItemBuilder {
	builder.type_ = type_
	builder.type_Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CreateTime(createTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.createTime = createTime
	builder.createTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) DepartureDime(departureDime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.departureDime = departureDime
	builder.departureDimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) MeetTime(meetTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.meetTime = meetTime
	builder.meetTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BeginChargeTime(beginChargeTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.beginChargeTime = beginChargeTime
	builder.beginChargeTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) FinishTime(finishTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.finishTime = finishTime
	builder.finishTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PayTime(payTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.payTime = payTime
	builder.payTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RefundTime(refundTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.refundTime = refundTime
	builder.refundTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) City(city string) *NotGenBDOfDaiJiaItemBuilder {
	builder.city = city
	builder.citySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) DestinationCity(destinationCity string) *NotGenBDOfDaiJiaItemBuilder {
	builder.destinationCity = destinationCity
	builder.destinationCitySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) NormalDistance(normalDistance float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.normalDistance = normalDistance
	builder.normalDistanceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) StartAddress(startAddress string) *NotGenBDOfDaiJiaItemBuilder {
	builder.startAddress = startAddress
	builder.startAddressSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) EndAddress(endAddress string) *NotGenBDOfDaiJiaItemBuilder {
	builder.endAddress = endAddress
	builder.endAddressSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) StartName(startName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.startName = startName
	builder.startNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) EndName(endName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.endName = endName
	builder.endNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ActualStartName(actualStartName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.actualStartName = actualStartName
	builder.actualStartNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ActualEndName(actualEndName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.actualEndName = actualEndName
	builder.actualEndNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RuleName(ruleName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.ruleName = ruleName
	builder.ruleNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UseCarSrv(useCarSrv string) *NotGenBDOfDaiJiaItemBuilder {
	builder.useCarSrv = useCarSrv
	builder.useCarSrvSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BudgetCenterName(budgetCenterName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.budgetCenterName = budgetCenterName
	builder.budgetCenterNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BudgetId(budgetId string) *NotGenBDOfDaiJiaItemBuilder {
	builder.budgetId = budgetId
	builder.budgetIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Remark(remark string) *NotGenBDOfDaiJiaItemBuilder {
	builder.remark = remark
	builder.remarkSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OrderAdditionalRemark(orderAdditionalRemark string) *NotGenBDOfDaiJiaItemBuilder {
	builder.orderAdditionalRemark = orderAdditionalRemark
	builder.orderAdditionalRemarkSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ApprovalReason(approvalReason string) *NotGenBDOfDaiJiaItemBuilder {
	builder.approvalReason = approvalReason
	builder.approvalReasonSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ApprovalCreateTime(approvalCreateTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.approvalCreateTime = approvalCreateTime
	builder.approvalCreateTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ApprovalLogs(approvalLogs string) *NotGenBDOfDaiJiaItemBuilder {
	builder.approvalLogs = approvalLogs
	builder.approvalLogsSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OutApprovalId(outApprovalId string) *NotGenBDOfDaiJiaItemBuilder {
	builder.outApprovalId = outApprovalId
	builder.outApprovalIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UpgradeType(upgradeType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.upgradeType = upgradeType
	builder.upgradeTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsFixedPrice(isFixedPrice string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isFixedPrice = isFixedPrice
	builder.isFixedPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsSelfDrive(isSelfDrive string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isSelfDrive = isSelfDrive
	builder.isSelfDriveSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsDiscountOrder(isDiscountOrder string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isDiscountOrder = isDiscountOrder
	builder.isDiscountOrderSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsCarpool(isCarpool string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isCarpool = isCarpool
	builder.isCarpoolSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsReassignment(isReassignment string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isReassignment = isReassignment
	builder.isReassignmentSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CallbackInfo(callbackInfo string) *NotGenBDOfDaiJiaItemBuilder {
	builder.callbackInfo = callbackInfo
	builder.callbackInfoSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ApprovalExtraInfo(approvalExtraInfo string) *NotGenBDOfDaiJiaItemBuilder {
	builder.approvalExtraInfo = approvalExtraInfo
	builder.approvalExtraInfoSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) AfterApprovalResult(afterApprovalResult string) *NotGenBDOfDaiJiaItemBuilder {
	builder.afterApprovalResult = afterApprovalResult
	builder.afterApprovalResultSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) AfterApprovalContent(afterApprovalContent string) *NotGenBDOfDaiJiaItemBuilder {
	builder.afterApprovalContent = afterApprovalContent
	builder.afterApprovalContentSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyId(companyId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyId = companyId
	builder.companyIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyName(companyName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyName = companyName
	builder.companyNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) LegalEntityId(legalEntityId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.legalEntityId = legalEntityId
	builder.legalEntityIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) LegalEntityName(legalEntityName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.legalEntityName = legalEntityName
	builder.legalEntityNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyCardRealPay(companyCardRealPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyCardRealPay = companyCardRealPay
	builder.companyCardRealPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UseCarTypeV2(useCarTypeV2 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.useCarTypeV2 = useCarTypeV2
	builder.useCarTypeV2Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BudgetItemName(budgetItemName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.budgetItemName = budgetItemName
	builder.budgetItemNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UseType(useType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.useType = useType
	builder.useTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) StartPrice(startPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.startPrice = startPrice
	builder.startPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) NormalFee(normalFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.normalFee = normalFee
	builder.normalFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) LowSpeedFee(lowSpeedFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.lowSpeedFee = lowSpeedFee
	builder.lowSpeedFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) EmptyFee(emptyFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.emptyFee = emptyFee
	builder.emptyFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) NightFee(nightFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.nightFee = nightFee
	builder.nightFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ResponsibleCancelFee(responsibleCancelFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.responsibleCancelFee = responsibleCancelFee
	builder.responsibleCancelFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) LimitFee(limitFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.limitFee = limitFee
	builder.limitFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) LimitPay(limitPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.limitPay = limitPay
	builder.limitPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) NormalTimeFee(normalTimeFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.normalTimeFee = normalTimeFee
	builder.normalTimeFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) DynamicPrice(dynamicPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.dynamicPrice = dynamicPrice
	builder.dynamicPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) TipFee(tipFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.tipFee = tipFee
	builder.tipFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BridgeFee(bridgeFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.bridgeFee = bridgeFee
	builder.bridgeFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) HighwayFee(highwayFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.highwayFee = highwayFee
	builder.highwayFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ParkFee(parkFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.parkFee = parkFee
	builder.parkFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) WaitFee(waitFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.waitFee = waitFee
	builder.waitFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IncentiveFee(incentiveFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.incentiveFee = incentiveFee
	builder.incentiveFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RedPacket(redPacket float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.redPacket = redPacket
	builder.redPacketSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OtherFee(otherFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.otherFee = otherFee
	builder.otherFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) MemberId(memberId float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.memberId = memberId
	builder.memberIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RefundPrice(refundPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.refundPrice = refundPrice
	builder.refundPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) GroupName(groupName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.groupName = groupName
	builder.groupNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) GroupId(groupId string) *NotGenBDOfDaiJiaItemBuilder {
	builder.groupId = groupId
	builder.groupIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyRealPreTaxPay(companyRealPreTaxPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyRealPreTaxPay = companyRealPreTaxPay
	builder.companyRealPreTaxPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyRealTaxPay(companyRealTaxPay float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyRealTaxPay = companyRealTaxPay
	builder.companyRealTaxPaySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UserPayTime(userPayTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.userPayTime = userPayTime
	builder.userPayTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UserPayType(userPayType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.userPayType = userPayType
	builder.userPayTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SettleType(settleType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.settleType = settleType
	builder.settleTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SubAccountName(subAccountName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.subAccountName = subAccountName
	builder.subAccountNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BelongBudgetCenterName(belongBudgetCenterName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.belongBudgetCenterName = belongBudgetCenterName
	builder.belongBudgetCenterNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BelongOutBudgetId(belongOutBudgetId string) *NotGenBDOfDaiJiaItemBuilder {
	builder.belongOutBudgetId = belongOutBudgetId
	builder.belongOutBudgetIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsCarpoolSuccess(isCarpoolSuccess int32) *NotGenBDOfDaiJiaItemBuilder {
	builder.isCarpoolSuccess = isCarpoolSuccess
	builder.isCarpoolSuccessSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyPayAble(companyPayAble float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyPayAble = companyPayAble
	builder.companyPayAbleSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ServiceType(serviceType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.serviceType = serviceType
	builder.serviceTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) BeforeApprovalResult(beforeApprovalResult string) *NotGenBDOfDaiJiaItemBuilder {
	builder.beforeApprovalResult = beforeApprovalResult
	builder.beforeApprovalResultSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) TimeSlotDiscount(timeSlotDiscount float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.timeSlotDiscount = timeSlotDiscount
	builder.timeSlotDiscountSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExtendInfo(extendInfo string) *NotGenBDOfDaiJiaItemBuilder {
	builder.extendInfo = extendInfo
	builder.extendInfoSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) Period(period string) *NotGenBDOfDaiJiaItemBuilder {
	builder.period = period
	builder.periodSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExcludingTaxPayPrice(excludingTaxPayPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.excludingTaxPayPrice = excludingTaxPayPrice
	builder.excludingTaxPayPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) TaxPayPrice(taxPayPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.taxPayPrice = taxPayPrice
	builder.taxPayPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExcludingTaxRefundPrice(excludingTaxRefundPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.excludingTaxRefundPrice = excludingTaxRefundPrice
	builder.excludingTaxRefundPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) TaxRefundPrice(taxRefundPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.taxRefundPrice = taxRefundPrice
	builder.taxRefundPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsSensitive(isSensitive int32) *NotGenBDOfDaiJiaItemBuilder {
	builder.isSensitive = isSensitive
	builder.isSensitiveSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SensitiveReason(sensitiveReason string) *NotGenBDOfDaiJiaItemBuilder {
	builder.sensitiveReason = sensitiveReason
	builder.sensitiveReasonSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CompanyCardRealRefund(companyCardRealRefund float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.companyCardRealRefund = companyCardRealRefund
	builder.companyCardRealRefundSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CancelTime(cancelTime string) *NotGenBDOfDaiJiaItemBuilder {
	builder.cancelTime = cancelTime
	builder.cancelTimeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CrossCityFee(crossCityFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.crossCityFee = crossCityFee
	builder.crossCityFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) RemoteAreaFee(remoteAreaFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.remoteAreaFee = remoteAreaFee
	builder.remoteAreaFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UseCarTypeName(useCarTypeName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.useCarTypeName = useCarTypeName
	builder.useCarTypeNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SubUseCarSrv(subUseCarSrv string) *NotGenBDOfDaiJiaItemBuilder {
	builder.subUseCarSrv = subUseCarSrv
	builder.subUseCarSrvSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) EnergyConsumeFee(energyConsumeFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.energyConsumeFee = energyConsumeFee
	builder.energyConsumeFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) IsUnusual(isUnusual string) *NotGenBDOfDaiJiaItemBuilder {
	builder.isUnusual = isUnusual
	builder.isUnusualSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UnusualType(unusualType string) *NotGenBDOfDaiJiaItemBuilder {
	builder.unusualType = unusualType
	builder.unusualTypeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UnusualContent(unusualContent string) *NotGenBDOfDaiJiaItemBuilder {
	builder.unusualContent = unusualContent
	builder.unusualContentSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PositionName(positionName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.positionName = positionName
	builder.positionNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) InstitutionName(institutionName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.institutionName = institutionName
	builder.institutionNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) UseCarService(useCarService string) *NotGenBDOfDaiJiaItemBuilder {
	builder.useCarService = useCarService
	builder.useCarServiceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo01(exInfo01 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo01 = exInfo01
	builder.exInfo01Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo02(exInfo02 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo02 = exInfo02
	builder.exInfo02Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo03(exInfo03 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo03 = exInfo03
	builder.exInfo03Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo04(exInfo04 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo04 = exInfo04
	builder.exInfo04Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo05(exInfo05 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo05 = exInfo05
	builder.exInfo05Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo06(exInfo06 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo06 = exInfo06
	builder.exInfo06Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo07(exInfo07 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo07 = exInfo07
	builder.exInfo07Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo08(exInfo08 string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo08 = exInfo08
	builder.exInfo08Set = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SpsPickUpServiceFee(spsPickUpServiceFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.spsPickUpServiceFee = spsPickUpServiceFee
	builder.spsPickUpServiceFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) DeductionTypeName(deductionTypeName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.deductionTypeName = deductionTypeName
	builder.deductionTypeNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PayChannel(payChannel string) *NotGenBDOfDaiJiaItemBuilder {
	builder.payChannel = payChannel
	builder.payChannelSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ResidentCityNames(residentCityNames string) *NotGenBDOfDaiJiaItemBuilder {
	builder.residentCityNames = residentCityNames
	builder.residentCityNamesSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OriginalPrice(originalPrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.originalPrice = originalPrice
	builder.originalPriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OneTimeOfferSubsidy(oneTimeOfferSubsidy float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.oneTimeOfferSubsidy = oneTimeOfferSubsidy
	builder.oneTimeOfferSubsidySet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SubsidyAmount(subsidyAmount float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.subsidyAmount = subsidyAmount
	builder.subsidyAmountSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) VoucherDeductionTypeName(voucherDeductionTypeName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.voucherDeductionTypeName = voucherDeductionTypeName
	builder.voucherDeductionTypeNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) PassengerMemberId(passengerMemberId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.passengerMemberId = passengerMemberId
	builder.passengerMemberIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ProjectExtInfo(projectExtInfo string) *NotGenBDOfDaiJiaItemBuilder {
	builder.projectExtInfo = projectExtInfo
	builder.projectExtInfoSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) OutLegalEntityId(outLegalEntityId string) *NotGenBDOfDaiJiaItemBuilder {
	builder.outLegalEntityId = outLegalEntityId
	builder.outLegalEntityIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) CarTravelInfo(carTravelInfo string) *NotGenBDOfDaiJiaItemBuilder {
	builder.carTravelInfo = carTravelInfo
	builder.carTravelInfoSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) InstitutionId(institutionId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.institutionId = institutionId
	builder.institutionIdSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExcludingServiceFee(excludingServiceFee float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.excludingServiceFee = excludingServiceFee
	builder.excludingServiceFeeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) EstimatePrice(estimatePrice float64) *NotGenBDOfDaiJiaItemBuilder {
	builder.estimatePrice = estimatePrice
	builder.estimatePriceSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) SubAccountCompanyName(subAccountCompanyName string) *NotGenBDOfDaiJiaItemBuilder {
	builder.subAccountCompanyName = subAccountCompanyName
	builder.subAccountCompanyNameSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo01Code(exInfo01Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo01Code = exInfo01Code
	builder.exInfo01CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo02Code(exInfo02Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo02Code = exInfo02Code
	builder.exInfo02CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo03Code(exInfo03Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo03Code = exInfo03Code
	builder.exInfo03CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo04Code(exInfo04Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo04Code = exInfo04Code
	builder.exInfo04CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo05Code(exInfo05Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo05Code = exInfo05Code
	builder.exInfo05CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo06Code(exInfo06Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo06Code = exInfo06Code
	builder.exInfo06CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo07Code(exInfo07Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo07Code = exInfo07Code
	builder.exInfo07CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ExInfo08Code(exInfo08Code string) *NotGenBDOfDaiJiaItemBuilder {
	builder.exInfo08Code = exInfo08Code
	builder.exInfo08CodeSet = true
	return builder
}
func (builder *NotGenBDOfDaiJiaItemBuilder) ParentInstitutionId(parentInstitutionId int64) *NotGenBDOfDaiJiaItemBuilder {
	builder.parentInstitutionId = parentInstitutionId
	builder.parentInstitutionIdSet = true
	return builder
}

func (builder *NotGenBDOfDaiJiaItemBuilder) Build() *NotGenBDOfDaiJiaItem {
	data := &NotGenBDOfDaiJiaItem{}
