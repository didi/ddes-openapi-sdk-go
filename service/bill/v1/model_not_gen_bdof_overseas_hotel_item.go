...
// NotGenBDOfOverseasHotelItem 未出账单 - 海外酒店,参考内部文档进行定义；
type NotGenBDOfOverseasHotelItem struct {
	...
	RoomNum                    *float32 `json:"room_num,omitempty"`                       // 预订房间数 1个人住:1 2个人住:0.5 3个人住:0.33、0.34
...
type NotGenBDOfOverseasHotelItemBuilder struct {
	...
	roomsSet                      bool
	roomNum                       float32 // 预订房间数 1个人住:1 2个人住:0.5 3个人住:0.33、0.34
	roomNumSet                    bool
...
func NewNotGenBDOfOverseasHotelItemBuilder() *NotGenBDOfOverseasHotelItemBuilder {
	return &NotGenBDOfOverseasHotelItemBuilder{}
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) SettleTime(settleTime string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.settleTime = settleTime
	builder.settleTimeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) MemberId(memberId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.memberId = memberId
	builder.memberIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PassengerMemberNumber(passengerMemberNumber string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.passengerMemberNumber = passengerMemberNumber
	builder.passengerMemberNumberSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PassengerName(passengerName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.passengerName = passengerName
	builder.passengerNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) Department(department string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.department = department
	builder.departmentSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BudgetCenterName(budgetCenterName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.budgetCenterName = budgetCenterName
	builder.budgetCenterNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BudgetCenterId(budgetCenterId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.budgetCenterId = budgetCenterId
	builder.budgetCenterIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BudgetCenterParentPathName(budgetCenterParentPathName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.budgetCenterParentPathName = budgetCenterParentPathName
	builder.budgetCenterParentPathNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OrderId(orderId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.orderId = orderId
	builder.orderIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OrderType(orderType string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.orderType = orderType
	builder.orderTypeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OrderStatus(orderStatus string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.orderStatus = orderStatus
	builder.orderStatusSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OrderSource(orderSource string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.orderSource = orderSource
	builder.orderSourceSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PayType(payType string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.payType = payType
	builder.payTypeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingMemberName(bookingMemberName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingMemberName = bookingMemberName
	builder.bookingMemberNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingMemberNumber(bookingMemberNumber string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingMemberNumber = bookingMemberNumber
	builder.bookingMemberNumberSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingDepName(bookingDepName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingDepName = bookingDepName
	builder.bookingDepNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingParentPathDepName(bookingParentPathDepName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingParentPathDepName = bookingParentPathDepName
	builder.bookingParentPathDepNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingDepId(bookingDepId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingDepId = bookingDepId
	builder.bookingDepIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingDepCode(bookingDepCode string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingDepCode = bookingDepCode
	builder.bookingDepCodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingDate(bookingDate string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingDate = bookingDate
	builder.bookingDateSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInDate(checkInDate string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInDate = checkInDate
	builder.checkInDateSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OriginalCheckOutDate(originalCheckOutDate string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.originalCheckOutDate = originalCheckOutDate
	builder.originalCheckOutDateSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckOutDate(checkOutDate string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkOutDate = checkOutDate
	builder.checkOutDateSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInNames(checkInNames string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInNames = checkInNames
	builder.checkInNamesSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckinNamesCn(checkinNamesCn string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkinNamesCn = checkinNamesCn
	builder.checkinNamesCnSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInMemberNumbers(checkInMemberNumbers string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInMemberNumbers = checkInMemberNumbers
	builder.checkInMemberNumbersSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInMemberDepartments(checkInMemberDepartments string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInMemberDepartments = checkInMemberDepartments
	builder.checkInMemberDepartmentsSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInDepName(checkInDepName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInDepName = checkInDepName
	builder.checkInDepNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInPathDepName(checkInPathDepName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInPathDepName = checkInPathDepName
	builder.checkInPathDepNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInDepId(checkInDepId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInDepId = checkInDepId
	builder.checkInDepIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CheckInDepCode(checkInDepCode string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.checkInDepCode = checkInDepCode
	builder.checkInDepCodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CityName(cityName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.cityName = cityName
	builder.cityNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) HotelType(hotelType string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.hotelType = hotelType
	builder.hotelTypeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) HotelName(hotelName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.hotelName = hotelName
	builder.hotelNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) Rooms(rooms string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.rooms = rooms
	builder.roomsSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RoomNum(roomNum float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.roomNum = roomNum
	builder.roomNumSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookDayNumber(bookDayNumber int32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookDayNumber = bookDayNumber
	builder.bookDayNumberSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) TotalNights(totalNights float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.totalNights = totalNights
	builder.totalNightsSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CompanyRealAmount(companyRealAmount float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.companyRealAmount = companyRealAmount
	builder.companyRealAmountSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CompanyPayType(companyPayType string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.companyPayType = companyPayType
	builder.companyPayTypeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PersonalRealPay(personalRealPay float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.personalRealPay = personalRealPay
	builder.personalRealPaySet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PersonalRealRefund(personalRealRefund float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.personalRealRefund = personalRealRefund
	builder.personalRealRefundSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ServiceFee(serviceFee float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.serviceFee = serviceFee
	builder.serviceFeeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CostDiscountBefore(costDiscountBefore float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.costDiscountBefore = costDiscountBefore
	builder.costDiscountBeforeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) Amount(amount float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.amount = amount
	builder.amountSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RcLowPrice(rcLowPrice string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.rcLowPrice = rcLowPrice
	builder.rcLowPriceSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RcAgreedPrice(rcAgreedPrice string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.rcAgreedPrice = rcAgreedPrice
	builder.rcAgreedPriceSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RcBook(rcBook string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.rcBook = rcBook
	builder.rcBookSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RcLevel(rcLevel string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.rcLevel = rcLevel
	builder.rcLevelSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) TravelPurpose(travelPurpose string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.travelPurpose = travelPurpose
	builder.travelPurposeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) TravelDescription(travelDescription string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.travelDescription = travelDescription
	builder.travelDescriptionSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PersonalCouponCost(personalCouponCost float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.personalCouponCost = personalCouponCost
	builder.personalCouponCostSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CompanyCouponCost(companyCouponCost float32) *NotGenBDOfOverseasHotelItemBuilder {
	builder.companyCouponCost = companyCouponCost
	builder.companyCouponCostSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ApprovalFirst(approvalFirst string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.approvalFirst = approvalFirst
	builder.approvalFirstSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ApprovalSecond(approvalSecond string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.approvalSecond = approvalSecond
	builder.approvalSecondSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ApprovalThird(approvalThird string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.approvalThird = approvalThird
	builder.approvalThirdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ApprovalHistory(approvalHistory string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.approvalHistory = approvalHistory
	builder.approvalHistorySet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RequisitionId(requisitionId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.requisitionId = requisitionId
	builder.requisitionIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OutRequisitionId(outRequisitionId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.outRequisitionId = outRequisitionId
	builder.outRequisitionIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) IsVat(isVat string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.isVat = isVat
	builder.isVatSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) TaxRatio(taxRatio string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.taxRatio = taxRatio
	builder.taxRatioSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExtraInfo(extraInfo string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.extraInfo = extraInfo
	builder.extraInfoSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) Remark(remark string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.remark = remark
	builder.remarkSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) TripReason(tripReason string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.tripReason = tripReason
	builder.tripReasonSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) UniqueKey(uniqueKey string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.uniqueKey = uniqueKey
	builder.uniqueKeySet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) LegalEntityId(legalEntityId int64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.legalEntityId = legalEntityId
	builder.legalEntityIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) LegalEntityName(legalEntityName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.legalEntityName = legalEntityName
	builder.legalEntityNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PassengerLegalEntityId(passengerLegalEntityId int64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.passengerLegalEntityId = passengerLegalEntityId
	builder.passengerLegalEntityIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PassengerLegalEntityName(passengerLegalEntityName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.passengerLegalEntityName = passengerLegalEntityName
	builder.passengerLegalEntityNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo01(exInfo01 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo01 = exInfo01
	builder.exInfo01Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo02(exInfo02 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo02 = exInfo02
	builder.exInfo02Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo03(exInfo03 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo03 = exInfo03
	builder.exInfo03Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo04(exInfo04 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo04 = exInfo04
	builder.exInfo04Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo05(exInfo05 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo05 = exInfo05
	builder.exInfo05Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo06(exInfo06 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo06 = exInfo06
	builder.exInfo06Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo07(exInfo07 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo07 = exInfo07
	builder.exInfo07Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo08(exInfo08 string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo08 = exInfo08
	builder.exInfo08Set = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) InstitutionName(institutionName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.institutionName = institutionName
	builder.institutionNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BudgetCenterCode(budgetCenterCode string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.budgetCenterCode = budgetCenterCode
	builder.budgetCenterCodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) PassengerMemberId(passengerMemberId int64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.passengerMemberId = passengerMemberId
	builder.passengerMemberIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) Reason(reason string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.reason = reason
	builder.reasonSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ProjectExtInfo(projectExtInfo string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.projectExtInfo = projectExtInfo
	builder.projectExtInfoSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ApprovalNormalHistory(approvalNormalHistory string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.approvalNormalHistory = approvalNormalHistory
	builder.approvalNormalHistorySet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) RankName(rankName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.rankName = rankName
	builder.rankNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CityId(cityId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.cityId = cityId
	builder.cityIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) EsDiffTaxFee(esDiffTaxFee float64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.esDiffTaxFee = esDiffTaxFee
	builder.esDiffTaxFeeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) InvoiceTaxRatio(invoiceTaxRatio string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.invoiceTaxRatio = invoiceTaxRatio
	builder.invoiceTaxRatioSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) InvoiceType(invoiceType string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.invoiceType = invoiceType
	builder.invoiceTypeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) OutLegalEntityId(outLegalEntityId string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.outLegalEntityId = outLegalEntityId
	builder.outLegalEntityIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) CountryNameCn(countryNameCn string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.countryNameCn = countryNameCn
	builder.countryNameCnSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) Currency(currency string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.currency = currency
	builder.currencySet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) TaxSupplementServiceFee(taxSupplementServiceFee float64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.taxSupplementServiceFee = taxSupplementServiceFee
	builder.taxSupplementServiceFeeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) InstitutionId(institutionId int64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.institutionId = institutionId
	builder.institutionIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) BookingMemberId(bookingMemberId int64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.bookingMemberId = bookingMemberId
	builder.bookingMemberIdSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExcludingServiceFee(excludingServiceFee float64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.excludingServiceFee = excludingServiceFee
	builder.excludingServiceFeeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExtendInfo(extendInfo string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.extendInfo = extendInfo
	builder.extendInfoSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) SubAccountCompanyName(subAccountCompanyName string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.subAccountCompanyName = subAccountCompanyName
	builder.subAccountCompanyNameSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo01Code(exInfo01Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo01Code = exInfo01Code
	builder.exInfo01CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo02Code(exInfo02Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo02Code = exInfo02Code
	builder.exInfo02CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo03Code(exInfo03Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo03Code = exInfo03Code
	builder.exInfo03CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo04Code(exInfo04Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo04Code = exInfo04Code
	builder.exInfo04CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo05Code(exInfo05Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo05Code = exInfo05Code
	builder.exInfo05CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo06Code(exInfo06Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo06Code = exInfo06Code
	builder.exInfo06CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo07Code(exInfo07Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo07Code = exInfo07Code
	builder.exInfo07CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ExInfo08Code(exInfo08Code string) *NotGenBDOfOverseasHotelItemBuilder {
	builder.exInfo08Code = exInfo08Code
	builder.exInfo08CodeSet = true
	return builder
}
func (builder *NotGenBDOfOverseasHotelItemBuilder) ParentInstiutionId(parentInstiutionId int64) *NotGenBDOfOverseasHotelItemBuilder {
	builder.parentInstiutionId = parentInstiutionId
	builder.parentInstiutionIdSet = true
	return builder
}

func (builder *NotGenBDOfOverseasHotelItemBuilder) Build() *NotGenBDOfOverseasHotelItem {
	data := &NotGenBDOfOverseasHotelItem{}
