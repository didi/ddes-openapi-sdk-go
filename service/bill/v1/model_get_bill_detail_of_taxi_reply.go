...
// GetBillDetailOfTaxiReply struct for GetBillDetailOfTaxiReply
type GetBillDetailOfTaxiReply struct {
	...
	Orders []BillDetailOfTaxiItem `json:"orders,omitempty"`  // 账单明细列表()
}
