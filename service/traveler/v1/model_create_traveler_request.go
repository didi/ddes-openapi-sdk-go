...
// CreateTravelerRequest struct for CreateTravelerRequest
...
type CreateTravelerRequestBuilder struct {
...
func NewCreateTravelerRequestBuilder() *CreateTravelerRequestBuilder {
	return &CreateTravelerRequestBuilder{}
}
func (builder *CreateTravelerRequestBuilder) ClientId(clientId string) *CreateTravelerRequestBuilder {
	builder.clientId = clientId
	builder.clientIdSet = true
	return builder
}
func (builder *CreateTravelerRequestBuilder) AccessToken(accessToken string) *CreateTravelerRequestBuilder {
	builder.accessToken = accessToken
	builder.accessTokenSet = true
	return builder
}
func (builder *CreateTravelerRequestBuilder) CompanyId(companyId string) *CreateTravelerRequestBuilder {
	builder.companyId = companyId
	builder.companyIdSet = true
	return builder
}
func (builder *CreateTravelerRequestBuilder) Timestamp(timestamp int64) *CreateTravelerRequestBuilder {
	builder.timestamp = timestamp
	builder.timestampSet = true
	return builder
}
func (builder *CreateTravelerRequestBuilder) Sign(sign string) *CreateTravelerRequestBuilder {
	builder.sign = sign
	builder.signSet = true
	return builder
}
func (builder *CreateTravelerRequestBuilder) ParamJson(paramJson string) *CreateTravelerRequestBuilder {
	builder.paramJson = paramJson
	builder.paramJsonSet = true
	return builder
}
func (builder *CreateTravelerRequestBuilder) ParamJsonObj(paramJsonObj TravelerInfo) *CreateTravelerRequestBuilder {
	builder.paramJsonObj = paramJsonObj
	builder.paramJsonObjSet = true
	return builder
}

func (builder *CreateTravelerRequestBuilder) Build() *CreateTravelerRequest {
	data := &CreateTravelerRequest{}
