...
// DelTravelerRequest struct for DelTravelerRequest
type DelTravelerRequest struct {
...
type DelTravelerRequestBuilder struct {
...
func NewDelTravelerRequestBuilder() *DelTravelerRequestBuilder {
	return &DelTravelerRequestBuilder{}
}
func (builder *DelTravelerRequestBuilder) ClientId(clientId string) *DelTravelerRequestBuilder {
	builder.clientId = clientId
	builder.clientIdSet = true
	return builder
}
func (builder *DelTravelerRequestBuilder) AccessToken(accessToken string) *DelTravelerRequestBuilder {
	builder.accessToken = accessToken
	builder.accessTokenSet = true
	return builder
}
func (builder *DelTravelerRequestBuilder) CompanyId(companyId string) *DelTravelerRequestBuilder {
	builder.companyId = companyId
	builder.companyIdSet = true
	return builder
}
func (builder *DelTravelerRequestBuilder) Timestamp(timestamp int64) *DelTravelerRequestBuilder {
	builder.timestamp = timestamp
	builder.timestampSet = true
	return builder
}
func (builder *DelTravelerRequestBuilder) Sign(sign string) *DelTravelerRequestBuilder {
	builder.sign = sign
	builder.signSet = true
	return builder
}
func (builder *DelTravelerRequestBuilder) ParamJson(paramJson string) *DelTravelerRequestBuilder {
	builder.paramJson = paramJson
	builder.paramJsonSet = true
	return builder
}
func (builder *DelTravelerRequestBuilder) ParamJsonObj(paramJsonObj TravelerInfo) *DelTravelerRequestBuilder {
	builder.paramJsonObj = paramJsonObj
	builder.paramJsonObjSet = true
	return builder
}

func (builder *DelTravelerRequestBuilder) Build() *DelTravelerRequest {
	data := &DelTravelerRequest{}
