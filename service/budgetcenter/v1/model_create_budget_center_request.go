...
func NewCreateBudgetCenterRequestBuilder() *CreateBudgetCenterRequestBuilder {
	return &CreateBudgetCenterRequestBuilder{}
}
func (builder *CreateBudgetCenterRequestBuilder) ClientId(clientId string) *CreateBudgetCenterRequestBuilder {
	builder.clientId = clientId
	builder.clientIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) AccessToken(accessToken string) *CreateBudgetCenterRequestBuilder {
	builder.accessToken = accessToken
	builder.accessTokenSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) CompanyId(companyId string) *CreateBudgetCenterRequestBuilder {
	builder.companyId = companyId
	builder.companyIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) Timestamp(timestamp int32) *CreateBudgetCenterRequestBuilder {
	builder.timestamp = timestamp
	builder.timestampSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) Sign(sign string) *CreateBudgetCenterRequestBuilder {
	builder.sign = sign
	builder.signSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) Type(type_ int32) *CreateBudgetCenterRequestBuilder {
	builder.type_ = type_
	builder.type_Set = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) Name(name string) *CreateBudgetCenterRequestBuilder {
	builder.name = name
	builder.nameSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) BudgetCycle(budgetCycle int32) *CreateBudgetCenterRequestBuilder {
	builder.budgetCycle = budgetCycle
	builder.budgetCycleSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) TotalQuota(totalQuota string) *CreateBudgetCenterRequestBuilder {
	builder.totalQuota = totalQuota
	builder.totalQuotaSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) OutBudgetId(outBudgetId string) *CreateBudgetCenterRequestBuilder {
	builder.outBudgetId = outBudgetId
	builder.outBudgetIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) LeaderId(leaderId string) *CreateBudgetCenterRequestBuilder {
	builder.leaderId = leaderId
	builder.leaderIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) LeaderEmployeeId(leaderEmployeeId string) *CreateBudgetCenterRequestBuilder {
	builder.leaderEmployeeId = leaderEmployeeId
	builder.leaderEmployeeIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) ParentId(parentId string) *CreateBudgetCenterRequestBuilder {
	builder.parentId = parentId
	builder.parentIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) OutParentId(outParentId string) *CreateBudgetCenterRequestBuilder {
	builder.outParentId = outParentId
	builder.outParentIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) OutParentName(outParentName string) *CreateBudgetCenterRequestBuilder {
	builder.outParentName = outParentName
	builder.outParentNameSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) MemberUsed(memberUsed int32) *CreateBudgetCenterRequestBuilder {
	builder.memberUsed = memberUsed
	builder.memberUsedSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) StartDate(startDate string) *CreateBudgetCenterRequestBuilder {
	builder.startDate = startDate
	builder.startDateSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) ExpiryDate(expiryDate string) *CreateBudgetCenterRequestBuilder {
	builder.expiryDate = expiryDate
	builder.expiryDateSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) LegalEntityId(legalEntityId string) *CreateBudgetCenterRequestBuilder {
	builder.legalEntityId = legalEntityId
	builder.legalEntityIdSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) BudgetExtraInfo(budgetExtraInfo string) *CreateBudgetCenterRequestBuilder {
	builder.budgetExtraInfo = budgetExtraInfo
	builder.budgetExtraInfoSet = true
	return builder
}
func (builder *CreateBudgetCenterRequestBuilder) BudgetExtraInfoObj(budgetExtraInfoObj map[string]string) *CreateBudgetCenterRequestBuilder {
