...
type UpdateBudgetCenterRequest struct {
	...
	OperateType          *string            `json:"operate_type,omitempty"`             // out_travelers操作方式：cover=覆盖，append=追加，remove=移除
...
type UpdateBudgetCenterRequestBuilder struct {
	...
	operateType             string // out_travelers操作方式
	operateTypeSet          bool
...
func (builder *UpdateBudgetCenterRequestBuilder) DepartmentId(departmentId string) *UpdateBudgetCenterRequestBuilder {
	builder.departmentId = departmentId
	builder.departmentIdSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) OutDepartmentId(outDepartmentId string) *UpdateBudgetCenterRequestBuilder {
	builder.outDepartmentId = outDepartmentId
	builder.outDepartmentIdSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) Scope(scope string) *UpdateBudgetCenterRequestBuilder {
	builder.scope = scope
	builder.scopeSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) ExtendField(extendField string) *UpdateBudgetCenterRequestBuilder {
	builder.extendField = extendField
	builder.extendFieldSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) ExtendFieldObj(extendFieldObj []ExtendFieldItem) *UpdateBudgetCenterRequestBuilder {
	builder.extendFieldObj = extendFieldObj
	builder.extendFieldObjSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) PoiList(poiList string) *UpdateBudgetCenterRequestBuilder {
	builder.poiList = poiList
	builder.poiListSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) PoiListObj(poiListObj []PoiItem) *UpdateBudgetCenterRequestBuilder {
	builder.poiListObj = poiListObj
	builder.poiListObjSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) OutTravelers(outTravelers string) *UpdateBudgetCenterRequestBuilder {
	builder.outTravelers = outTravelers
	builder.outTravelersSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) OutTravelersObj(outTravelersObj []OutTravelerItem) *UpdateBudgetCenterRequestBuilder {
	builder.outTravelersObj = outTravelersObj
	builder.outTravelersObjSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) OperateType(operateType string) *UpdateBudgetCenterRequestBuilder {
	builder.operateType = operateType
	builder.operateTypeSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) BelongEnterpriseName(belongEnterpriseName string) *UpdateBudgetCenterRequestBuilder {
	builder.belongEnterpriseName = belongEnterpriseName
	builder.belongEnterpriseNameSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) TaxpayerNo(taxpayerNo string) *UpdateBudgetCenterRequestBuilder {
	builder.taxpayerNo = taxpayerNo
	builder.taxpayerNoSet = true
	return builder
}
func (builder *UpdateBudgetCenterRequestBuilder) OutLegalEntityId(outLegalEntityId string) *UpdateBudgetCenterRequestBuilder {
...
func (builder *UpdateBudgetCenterRequestBuilder) Build() *UpdateBudgetCenterRequest {
	...
	if builder.operateTypeSet {
		data.OperateType = &builder.operateType
	}
